...
/*いいね機能の場合、見ている全ツイートに対して
いいね済かの判定があり、同じViewファイルに
storeとdestroyのactionが異なったformが混在した形で渡される。
そのためログインしているユーザが
ツイートに対していいねをしているかの判定はフロントで行い、
その判定の分岐でstoreかdestroy
どちらかのデータがControllerに渡される。*/